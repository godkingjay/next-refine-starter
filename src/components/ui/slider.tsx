            ...
            return (
              <>
                {showTooltip ? (
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <SliderPrimitive.Thumb
                          key={`thumb-${index}`}
                          className="range-thumb block h-5 w-5 cursor-pointer rounded-full border-2 ring-offset-background transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                        />
                      </TooltipTrigger>
                  ...
                  <SliderPrimitive.Thumb
                    key={`thumb22-${index}`}
                    className="range-thumb block h-5 w-5 cursor-pointer rounded-full ring-2 ring-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50"
                  />
                )}
              </>
            );
