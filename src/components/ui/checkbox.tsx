      ...
      {children ? (
        <div className="flex items-center">
          ...
          <Label
            htmlFor={props.id}
            className={cn(
              "transition-colors-opacity before:transition-width flex-1 cursor-pointer font-normal text-muted-foreground motion-reduce:transition-none ltr:pl-2.5 rtl:pr-2.5",
              {
                "text-xs": size === "xs",
                "text-sm": size === "sm",
                "text-base": size === "md",
