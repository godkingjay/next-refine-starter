          ...
          <form onSubmit={onSubmit} className="mt-8 2xl:mt-7">
            <div className="relative">
              ...
              <Label
                htmlFor="email"
                className={cn(
                  "text-default-600 absolute start-1 top-2 z-10 origin-[0] -translate-y-5 scale-75 transform rounded-t bg-background px-2 text-base duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4",
                  {
            ...
            <div className="relative mt-6">
              ...
              <div
                className="absolute right-1 top-1/2 -translate-y-1/2 cursor-pointer ltr:right-4 rtl:left-4"
            ...
            <div className="mb-6 mt-5 flex flex-wrap gap-2">
              <div className="flex flex-1 items-center gap-1.5">
                ...
                <Label
                  ...
                  className="text-default-600 cursor-pointer whitespace-nowrap text-sm"
                >
                  Remember me
                </Label>
              </div>
