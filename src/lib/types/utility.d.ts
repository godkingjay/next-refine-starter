...
export type TransformObjectKeys<
    T,
    O extends Record<string | number, string | number | symbol>,
> = {
...
export type DeepSnakeToKebabCaseKeys<T> = {
    [K in keyof T as SnakeToKebabCase<K & string>]: T[K] extends object
        ? DeepSnakeToKebabCaseKeys<T[K]>
        : T[K];
};
...
export type DeepCamelToKebabCaseKeys<T> = {
    [K in keyof T as CamelToKebabCase<K & string>]: T[K] extends object
        ? DeepCamelToKebabCaseKeys<T[K]>
        : T[K];
};
...
export type DeepKebabToSnakeCaseKeys<T> = {
    [K in keyof T as KebabToSnakeCase<K & string>]: T[K] extends object
        ? DeepKebabToSnakeCaseKeys<T[K]>
        : T[K];
};
...
export type DeepKebabToCamelCaseKeys<T> = {
    [K in keyof T as KebabToCamelCase<K & string>]: T[K] extends object
        ? DeepKebabToCamelCaseKeys<T[K]>
        : T[K];
};
...
export type DeepUppercaseKeys<T> = {
    [K in keyof T as Uppercase<K & string>]: T[K] extends object
        ? DeepUppercaseKeys<T[K]>
        : T[K];
};
...
export type DeepLowercaseKeys<T> = {
    [K in keyof T as Lowercase<K & string>]: T[K] extends object
        ? DeepLowercaseKeys<T[K]>
        : T[K];
};
...
export type DeepDecapitalizeKeys<T> = {
    [K in keyof T as Uncapitalize<K & string>]: T[K] extends object
        ? DeepDecapitalizeKeys<T[K]>
        : T[K];
};
 ...
 */
export type AddPrefixToAllKeys<
    T extends Record<string | number, any>,
    P extends string,
> = {
    [K in keyof T as `${P}${K & (string | number)}`]: T[K];
};
 ...
 */
export type AddSuffixToAllKeys<
    T extends Record<string | number, any>,
    S extends string,
> = {
    [K in keyof T as `${K & (string | number)}${S}`]: T[K];
};
 ...
 */
export type AddPrefixAndSuffixToAllKeys<
    T extends Record<string | number, any>,
    P extends string,
    S extends string,
> = {
    [K in keyof T as `${P}${K & (string | number)}${S}`]: T[K];
};
 ...
 */
export type RemovePrefixAndSuffixFromAllKeys<
    T,
    P extends string,
    S extends string,
> = {
 ...
 */
export type AddPrefixAndSuffixToKeys<
    T extends Record<string | number, any>,
    P extends string,
    S extends string,
> = {
 ...
 */
export type RemovePrefixAndSuffixFromKeys<
    T,
    P extends string,
    S extends string,
> = {
