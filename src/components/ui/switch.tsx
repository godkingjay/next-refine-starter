  ...
  (
    ...
    >
      ...
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none z-10 flex h-4 w-4 origin-right items-center justify-center rounded-full bg-background shadow-lg ring-0 transition-all ltr:data-[state=checked]:ml-5 rtl:data-[state=checked]:mr-5 rtl:data-[state=unchecked]:mr-0.5",
          thumbClass,
          {
