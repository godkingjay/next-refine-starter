    ...
    return (
      <li
        ...
        className={cn(timelineItemVariants({ variant }), className, {
          "[&_.tm-content-wrapper]:pr-8 [&_.tm-content-wrapper]:text-right [&_.tm-separator]:left-[unset] [&_.tm-separator]:right-0":
            position === "left",
          "ltr:[&_.tm-content-wrapper]:pl-8 rtl:[&_.tm-content-wrapper]:pr-8 rtl:[&_.tm-content-wrapper]:text-right ltr:[&_.tm-separator]:left-0 rtl:[&_.tm-separator]:left-[unset] rtl:[&_.tm-separator]:right-0":
          ...
          "rtl:mr-auto [&_.tm-content-wrapper]:pr-4 [&_.tm-content-wrapper]:text-right rtl:[&_.tm-content-wrapper]:pl-4 [&_.tm-separator]:left-[unset] [&_.tm-separator]:right-[-17px] rtl:[&_.tm-separator]:right-[-8px]":
...
>(({ className, children, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "bg-default-200 tm-connector w-[2px] grow",
